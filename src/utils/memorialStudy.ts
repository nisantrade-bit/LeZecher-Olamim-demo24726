...
export const HALAKHOT: HalakhaRecord[] = [
  {
    ...
    text: {
      ...
      ru: "Древний и повсеместный обычай — зажигать поминальную свечу накануне годовщины кончины (Йарцайт) и накануне Йом Кипура, ибо «душа человека — светильник Господень». Свеча должна гореть все 24 часа годовщины."
    },
    explanation: {
  ...
  },
  {
    ...
    text: {
      ...
      ru: "Благочестивый обычай — посещать могилу в день годовщины (Йарцайт). Там молятся за возвышение души и просят о милосердии для живых. Не посещают могилу в Шаббат, праздники, полупраздничные дни и Рош Ходеш."
    },
    explanation: {
  ...
  },
  {
    ...
    text: {
      ...
      ru: "В день годовщины (Йарцайт) очень правильно молиться во всех службах в миньяне в синагоге и вести молитву в качестве ведущего (Шалиах Цибур), если сын умеет делать это правильно и это не вызывает споров."
    },
    explanation: {
