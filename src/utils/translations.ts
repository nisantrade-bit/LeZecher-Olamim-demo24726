...
export const translations: Record<'he' | 'en' | 'ru', Translation> = {
  he: {
    ...
    upcomingMemorials: "אזכרות בטווח 12 הימים הקרובים (כולל שבתות):",
  ...
  en: {
    ...
    upcomingMemorials: "Yahrzeits in the upcoming 12 days (including Shabbats):",
  ...
  ru: {
    ...
    upcomingMemorials: "Йарцайты в ближайшие 12 дней (включая Шаббаты):",
